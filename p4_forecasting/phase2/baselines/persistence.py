"""Persistence baseline for cyclone forecasting (P4 Phase 2).

Persistence: future cyclone position and wind speed are predicted as the
current/latest observed position and wind speed.
...
def persistence_forecast(history: np.ndarray) -> np.ndarray:
    """Produce a (3,3) persistence forecast from a (5,7) history block.
